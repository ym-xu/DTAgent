...
def gpt_llm_call(
    ...
    *,
    ...
    """
    Minimal GPT (OpenAI) caller used by components relying on LLM summarization.
...
def qwen_llm_call(
    ...
    *,
    ...
    """
    Minimal Qwen (DashScope) caller used by components relying on LLM summarization.
